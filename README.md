...
<div align= "center"> 
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: center; color: #282d33;">
        <strong>협업</strong>을 통해 더 나은 솔루션을 만들고, <strong>책임감</strong>있는 개발로 <strong>의미 있는 가치를 창출하는 백엔드 개발자</strong><br>
        🎓 광주대학교 컴퓨터공학부 <br/>
...
![TokenPhage](https://api.tokenphage.com/badge/dmlcksghd)
